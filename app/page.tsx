        ...
        <div className="min-h-screen w-full flex flex-col items-center justify-center px-4 py-8 md:px-8 md:py-12 relative bg-black">
          ...
          >
            ...
            {showBookmarksPanel && !isReaderMode && (
              <div className="fixed inset-x-4 bottom-16 md:inset-auto md:right-6 md:bottom-20 md:w-80 z-40 rounded-2xl border border-white/15 bg-black/80 backdrop-blur-2xl p-4 text-xs shadow-[0_30px_80px_rgba(0,0,0,0.85)] space-y-3 pointer-events-auto">
            ...
            <AnimatePresence>
              {showInfoPanel && !isReaderMode && directorInfo && (
                <motion.aside
                  ...
                  className="fixed right-4 top-20 bottom-6 w-80 max-w-[80vw] z-40 rounded-2xl border border-white/15 bg-black/85 backdrop-blur-2xl shadow-[0_30px_80px_rgba(0,0,0,0.95)] p-5 text-sm pointer-events-auto"
                >
